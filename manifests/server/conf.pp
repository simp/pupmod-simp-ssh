...
# [*use_iptables*]
# Type: Boolean
# Default: defined('$::use_iptables') ? { true => getvar('::use_iptables'), default => hiera('use_iptables', false) }
#   If true, use the SIMP iptables class.
#
# [*use_ldap*]
# Type: Boolean
# Default: defined('$::use_ldap') ? { true => getvar('::use_ldap'), default => hiera('use_ldap', false) },
...
class ssh::server::conf (
  ...
  $x11forwarding = false,
  $client_nets = 'any',
  $use_iptables = defined('$::use_iptables') ? { true => getvar('::use_iptables'), default => hiera('use_iptables', false) },
  $use_ldap = defined('$::use_ldap') ? { true => getvar('::use_ldap'), default => hiera('use_ldap', false) },
